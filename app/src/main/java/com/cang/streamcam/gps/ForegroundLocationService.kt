...
import com.cang.streamcam.BuildConfig
import com.cang.streamcam.MainApplication
import com.cang.streamcam.R
import com.cang.streamcam.gps.ForegroundLocationService.LocalBinder
...
//                    }
    ...
    private fun buildNotification(location: Location?): Notification {
        ...
        if (location != null) {
            ...
            lifecycleScope.launch {
                locationPreferences.setLastLocationn(contentText)
            }
        } else {
            contentText = getString(R.string.waiting_for_location)
        }
...
class ForegroundLocationServiceConnection: ServiceConnection {
    ...
    companion object {
        private var flsc: ForegroundLocationServiceConnection? = null

        fun getServiceConnection(): ForegroundLocationServiceConnection? {
            return flsc
        }
    }
}

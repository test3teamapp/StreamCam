...
class LocationRepository  private constructor(
    ...
    companion object{
        private var singletonObject: LocationRepository? = null

        public fun getInstance(ctx: Context):LocationRepository{
            if(singletonObject == null){
                singletonObject = LocationRepository(
                    LocationServices.getFusedLocationProviderClient(ctx)
                )
            }
            return singletonObject as LocationRepository
        }
    }
}
